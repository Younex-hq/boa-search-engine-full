...
class DirectionFilter extends QueryFilter
{
  ...
  {
    return $this->builder->whereIn("location_id", explode(',', $value));
  }

  public function parentDirection($value)
  {
    return $this->builder->whereIn("parent_direction_id", explode(',', $value));
  }
  ...
  protected $sortable = [
    'name',
    'location' => 'location_id', // sorted by location id not alphabiticly
    'is_active' => 'doc_statut_id',
